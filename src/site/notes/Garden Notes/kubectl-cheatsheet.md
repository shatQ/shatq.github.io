---
{"dg-publish":true,"permalink":"/garden-notes/kubectl-cheatsheet/","tags":["note","seedling"],"created":"2023-01-30T12:59:00","updated":"2024-11-29T14:51"}
---
...
- `kubectl create`
	- Is for [imperative management](https://kubernetes.io/docs/tutorials/object-management-kubectl/imperative-object-management-configuration/). In this approach, you tell the Kubernetes API what you want to `create`, `replace`, or `delete`. 
...
- `kubectl apply`
	- Is part of the [declarative management](https://kubernetes.io/docs/tutorials/object-management-kubectl/declarative-object-management-configuration/) approach in which changes that you may have applied to a live object (i.e., through scale) are “maintained” even if you apply other changes to the object. 
